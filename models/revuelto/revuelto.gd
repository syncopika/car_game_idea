...
var texture = preload("res://models/revuelto/revuelto_texture.png")
...
func _ready():
	...
	var mat
	if car_mat == "normal":
		mat = preload("res://models/revuelto/Material.material")
...
func _physics_process(delta):
	...
	if Input.is_action_pressed("drift"):
		$back_left_wheel.wheel_friction_slip = 0.2
		$back_right_wheel.wheel_friction_slip = 0.2
